 ...
 * @since 3.0
 */
Ext.define('NX.coreui.view.repositorycma.RepositoryCMAList', {
  extend: 'NX.view.drilldown.Master',
  alias: 'widget.nx-coreui-repositorycma-list',
  requires: [
    'NX.I18n'
  ],
  ...
  viewConfig: {
    emptyText: NX.I18n.get('ADMIN_REPOSITORIES_CMA_LIST_EMPTY_STATE'),
